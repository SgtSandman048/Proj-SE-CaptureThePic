...
// ══════════════════════════════════════════════════════════════
export default function ImageDetailAdmin({ imageId, user, onBack, onNavigate }) {
        ...
        <div className="detail-right">
          ...
          <div className="purchase-card">
            ...
            <div className="purchase-card-body">
              ...
              <div className="license-info" style={{ color: "var(--text-lo)" }}>
                <strong style={{ color: "var(--admin-accent)" }}>Admin View</strong><br />
                Full image details and metadata visible.
                Deleting will permanently remove this image and all associated orders.
              </div>
...
function DetailTopBar({ onBack }) {
  ...
  return (
    <header className="detail-topbar">
      ...
      <div className="logo"><span style={{fontSize:"11px",fontStyle:"normal",fontFamily:"monospace",color:"#f59e0b",marginRight:"4px"}}>(ADMIN)</span>Imagery</div>
    </header>
  );
}